...
const Icons = {
  ...
  set: {
    ...
    /* 🍾 Бутылочка: контурная бутылка, горлышком вверх (это «стрелка» игры) */
    bottle:
      '<path d="M10.6 2.8h2.8v1.8h-2.8z"/>' +
      '<path d="M11.1 4.6v2.8"/>' +
      '<path d="M12.9 4.6v2.8"/>' +
      '<path d="M8.5 7.4h7l2.5 2.5v5.2a2.6 2.6 0 0 1-2.6 2.6H8.6a2.6 2.6 0 0 1-2.6-2.6v-5.2l2.5-2.5Z"/>' +
